...
syn keyword gpRule EXTERNAL LIST POOL FOR FILESET FROM GROUP LIMIT
syn keyword gpRule MIGRATE OPTS REPLICATE RESTORE TO RULE SET SHOW SIZE
...
" GPFS Policy build in functions
...
" - double quotes "
" - single quotes '
syn region gpStringD start=+"+ end=+"\|$+
syn region gpStringS start=+'+ end=+'\|$+
...
hi def link gpStringD	String
hi def link gpStringS	String
